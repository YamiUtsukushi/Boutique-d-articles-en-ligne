...
function WomenAndMixte() {
  // Filtrer les données pour ne retenir que les articles catégorisés pour femmes et mixte
  const filteredData = data.filter(item => item.category === 'f' || item.category === 'mixte');
